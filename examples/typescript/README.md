...
This project uses TypeScript for its application, tests and behavior guards. Node.js with tsx runs the code; TypeScript checks its types.
...
For project creation, see the [setup instructions](https://github.com/EngBanan/mawja-operating-model/blob/main/examples/README.md#typescript). Run these commands from the generated project:
